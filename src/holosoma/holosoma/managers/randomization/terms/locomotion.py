...
# --- Object physics DR (IsaacSim-only startup terms). Kept here (referenced by the shipped
# wbt randomization preset by dotted path); the scene-objects feature branch relocates these to
# terms/objects.py and makes them cross-backend. ---
