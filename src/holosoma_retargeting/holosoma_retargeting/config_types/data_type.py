...
SEED_DEMO_JOINTS = [
    # BONES-SEED / SOMA (NOVA rig) skeleton, 78 joints, verified by parsing
    # the bundled BVH (dependencies/soma-retargeter/assets/motions/bvh/)
    "Root",
    "Hips",
    "Spine1",
    "Spine2",
...
JOINTS_MAPPINGS = {
    ...
    ("seed", "g1"): {
        # Robot-link targets taken directly from soma-retargeter's own
        # SEED->G1 ik_map (soma_retargeter/configs/unitree_g1/
